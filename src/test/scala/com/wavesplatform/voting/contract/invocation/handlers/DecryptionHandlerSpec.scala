...
class DecryptionHandlerSpec extends AnyFreeSpec with Matchers {
  ...
  "all validations passed" in {
    ...
    val callRes = DecryptionHandler.call(contractTransaction, contractState)
